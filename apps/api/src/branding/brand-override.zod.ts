...
/**
 * Versioned partial-override contract for tenant branding.
 *
 * Strict camelCase subset per design D5; value formats reuse the approved
 * `brandThemeSchema` primitives. Unknown keys are rejected — this is a
 * distinct sibling schema, never a mutation of the shipped full-theme one.
 */
 ...
 */
export function validateBrandOverride(input: unknown): z.infer<typeof brandOverrideSchema> {
